...
The [project's GitHub README](https://github.com/qarmin/czkawka) does a pretty good job of describing the software: *Czkawka is a simple, fast and free app to remove unnecessary files from your computer.* One thing I noticed right away is that it's GUI based, a development choice which might rustle some feathers, but I figured I'd give it a shot anyway. Read on below for a walkthrough of how I deployed this in Unraid and used it to find duplicate files in my array.
